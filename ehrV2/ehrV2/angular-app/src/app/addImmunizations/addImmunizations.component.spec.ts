...
import { addImmunizationsComponent } from './addImmunizations.component';
...
describe('addImmunizationsComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ addImmunizationsComponent ],
imports: [
    BrowserModule,
    FormsModule,
    ReactiveFormsModule,
...
providers: [addImmunizationsService,DataService,Configuration]
    })
    .compileComponents();
  }));
