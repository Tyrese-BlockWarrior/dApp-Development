 ...
 * @param {composers.healthrecords.assignMedProvider} assignMedProvider - the assignMedProvider transaction
 * @transaction
 */
function assignMedProvider(assignMedProvider) {
  ...
  return getAssetRegistry('composers.participants.Childform')
 ...
 * @param {composers.healthrecords.authMember} authMember - the authMember transaction
 * @transaction
 */
 ...
 * @param {composers.healthrecords.removeMemberAuth} removeMemberAuth - the removeMemberAuth transaction
 * @transaction
 */
 ...
 * @param {composers.healthrecords.addImmunizations} addImmunizations - the addImmunizations transaction
 * @transaction
 */
function addImmunizations(addImmunizations){
	var vaccines = addImmunizations.vaccines;
	var child = addImmunizations.childform;
  	var immunizations = child.immunization;
 ...
 * @param {composers.healthrecords.updateChildForm} updateChildForm - the updateChildForm transaction
 * @transaction
 */
 ...
 * @param {composers.healthrecords.reassignGuardian} reassignGuardian - the reassignGuardian transaction
 * @transaction
 */
